...

{
  dconf.settings = {
    ...
    "org/gnome/shell/extensions/display-configuration-switcher" = {
      config = "[('Work', uint32 522154615, n  [(0, 0, 1.5, uint32 0, true, [('DP-0', '3840x2160@59.997', @a{sv} {})])], n  {'layout-mode': <uint32 3>}, n  [('DP-0', 'DEL', 'DELL G3223Q', '6BX70P3'), ('HDMI-0', 'DEL', 'DELL U2520D', 'H4MM923')]n), n('Personal', 2225729516, n  [(0, 0, 1.5, 0, true, [('DP-0', '3840x2160@59.997', {})]), n  (5120, 0, 1.25, 0, false, [('HDMI-0', '2560x1440@59.951', {})])], n  {'layout-mode': <uint32 3>}, n  [('DP-0', 'DEL', 'DELL G3223Q', '6BX70P3'), ('HDMI-0', 'DEL', 'DELL U2520D', 'H4MM923')]n)]n";
    };

    "org/gnome/shell/extensions/gsconnect" = {
      id = "1f9fdf4b-5cfc-4ff4-98d6-1c4cf6bca3e6";
      name = "ozpc";
    };
